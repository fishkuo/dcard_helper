...
post_id = pd.read_csv("post_id.csv", names = ["post_id","post_title","board_name","alias"])
...
# save as csv
post.to_csv("dcard_post_content.csv",header=False)
comment.to_csv("dcard_post_comment.csv",header=False)